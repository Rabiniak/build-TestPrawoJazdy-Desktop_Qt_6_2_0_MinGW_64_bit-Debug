...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_kata_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_kata_t qt_meta_stringdata_kata = {
    {
QT_MOC_LITERAL(0, 4) // "kata"
...
const QMetaObject kata::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_kata.offsetsAndSize,
    qt_meta_data_kata,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_kata_t
, QtPrivate::TypeAndForceComplete<kata, std::true_type>
